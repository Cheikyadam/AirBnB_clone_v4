$(document).ready(function () {
  ...
  $('.locations input[type=checkbox]').click(function () {
    ...
    $('.locations h2 input[type=checkbox]:checked').each(function () {
      lName.push($(this).attr('data-name'));
      statesId.push($(this).attr('data-id'));
    });

    $('.locations .city input[type=checkbox]:checked').each(function () {
      lName.push($(this).attr('data-name'));
